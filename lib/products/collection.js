...
const collection = {
    ...
    getAccountBalance  : async (accessToken, subscriptionKey, env="sandbox", cache = 'no-cache')=>{
            ...
            try{
                ...
                const rep = await axios.get(`https://sandbox.momodeveloper.mtn.com/collection/v1_0/account/balance`, {headers});
    ...
    getBasicUserInfo : async (accessToken, subscriptionKey, acountHolderMSISDN='00242064581139', env='sandbox', cache = 'no-cache')=>{
        ...
        try{
            ...
            const rep = await axios.get(`https://sandbox.momodeveloper.mtn.com/collection/v1_0/accountholder/msisdn/${acountHolderMSISDN}/basicuserinfo`, {headers});
