...
var disbursement = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            headers = {
              'Authorization': basic,
              //'Basic ZGUxMzU1ZjctZDA5ZS00NjdkLWEzN2UtYjM4YTcwNGNmZDg2Ojk0ODE4NzVkMTZkODQyNDM5MzY4MzRjNmYwMWJhZGY0',
              'Cache-Control': cache,
              'Ocp-Apim-Subscription-Key': subscriptionKey
            };
            _context.prev = 3;
            _context.next = 6;
            return axios.post("".concat(root, "/disbursement/token/"), {}, {
              headers: headers
            });
          case 6:
            rep = _context.sent;
  ...
  depositV2: function () {
    var _depositV = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref2) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 2;
            _context2.next = 5;
            return axios.post("".concat(root, "/disbursement/v2_0/deposit"), body, {
              headers: headers
            });
          case 5:
            rep = _context2.sent;
    ...
    function depositV2(_x2) {
      return _depositV.apply(this, arguments);
    }
    return depositV2;
  }(),
  Transfer: function () {
    var _Transfer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_ref3) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            _context3.next = 5;
            return axios.post("".concat(root, "/disbursement/v1_0/transfer"), body, {
              headers: headers
            });
          case 5:
            rep = _context3.sent;
