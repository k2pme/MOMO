...
async function requestToPay(cfg, logger, params) {
  ...
  const r = await axios3.post(`${cfg.baseUrl}/collection/v1_0/requesttopay`, payload, { headers });
...
async function getRequestStatus(cfg, logger, transactionId) {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/collection/v1_0/requesttopay/${transactionId}`, { headers });
...
async function getBalance(cfg, logger) {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/collection/v1_0/account/balance`, { headers });
...
async function validateAccount(cfg, logger, accountHolderId, accountHolderIdType = "msisdn") {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/collection/v1_0/accountholder/${accountHolderIdType}/${accountHolderId}/active`, { headers });
...
async function transfer(cfg, logger, params) {
  ...
  const r = await axios3.post(`${cfg.baseUrl}/disbursement/v1_0/transfer`, payload, { headers });
...
async function getStatus(cfg, logger, transactionId) {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/disbursement/v1_0/transfer/${transactionId}`, { headers });
...
async function cashTransfer(cfg, logger, params) {
  ...
  const r = await axios3.post(`${cfg.baseUrl}/remittance/v1_0/transfer`, payload, { headers });
...
async function getTransferStatus(cfg, logger, transactionId) {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/remittance/v1_0/transfer/${transactionId}`, { headers });
...
async function getAccountBalance(cfg, logger) {
  ...
  const r = await axios3.get(`${cfg.baseUrl}/remittance/v1_0/account/balance`, { headers });
